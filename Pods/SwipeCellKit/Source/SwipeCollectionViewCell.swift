 ...
 */
//protocol PassNumberAndNewNameOfTheDeck : class {
...
open class SwipeCollectionViewCell: UICollectionViewCell {
    ...
    override open func prepareForReuse() {
        ...
        reset()
        resetSelectedState()
        cancelEditingButtonToHide.isHidden = true
        completeEditingButtonToHide.isHidden = true
        startEditingButtonForHiding.isHidden = false
     
        nameOfDeck.isUserInteractionEnabled = false
        nameOfDeck.resignFirstResponder()
    }
    ...
    @IBOutlet weak var startEditingButtonForHiding: UIButton!
    @IBAction func startEditingButton(_ sender: UIButton) {
        completeEditingButtonToHide.isHidden = false
        cancelEditingButtonToHide.isHidden = false
        startEditingButtonForHiding.isHidden = true
        nameOfDeck.isUserInteractionEnabled = true
        nameOfDeck.becomeFirstResponder()

        delegate?.checkIfICanGoToCardsCollectionViewControllerAndScroll(canIGoAndScroll: false)
        
        
    }
    
    @IBOutlet weak var completeEditingButtonToHide: UIButton!
    @IBAction func completeEditingButton(_ sender: UIButton) {
        completeEditingButtonToHide.isHidden = true
        cancelEditingButtonToHide.isHidden = true
        startEditingButtonForHiding.isHidden = false
        ...
        delegate?.getNumberAndNewNameOfTheDeck(numberOfDeck: indexPath!.item, nameOfDeck: nameOfDeck.text!)
        delegate?.checkIfICanGoToCardsCollectionViewControllerAndScroll(canIGoAndScroll: true)

    }
    
    @IBOutlet weak var settingButtonToHide: UIButton!
    @IBAction func settingButton(_ sender: UIButton) {
    }
    
    @IBOutlet weak var cancelEditingButtonToHide: UIButton!
    @IBAction func cancelEditingButton(_ sender: UIButton) {
        cancelEditingButtonToHide.isHidden = true
        completeEditingButtonToHide.isHidden = true
        startEditingButtonForHiding.isHidden = false
        nameOfDeck.isUserInteractionEnabled = false
        nameOfDeck.resignFirstResponder()
        delegate?.updateCollectionViewAfterCancelingOfEditingCard()
        delegate?.checkIfICanGoToCardsCollectionViewControllerAndScroll(canIGoAndScroll: true)
